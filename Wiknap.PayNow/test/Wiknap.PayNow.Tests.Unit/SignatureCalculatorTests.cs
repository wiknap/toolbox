...
public sealed class SignatureCalculatorTests
{
    ...
    [Fact]
    public void Given_OnlyIdempotencyKey_When_Calculate_Then_ReturnsValidSignature()
    {
        // Arrange & Act
    ...
    [Fact]
    public void Given_IdempotencyKeyAndParameters_When_Calculate_Then_ReturnsValidSignature()
    {
        // Arrange & Act
    ...
    [Fact]
    public void Given_IdempotencyKeyAndBody_When_Calculate_Then_ReturnsValidSignature()
    {
        // Arrange
    ...
    [Fact]
    public void Given_ContentAndMatchingSignature_When_IsNotificationSignatureValid_Then_ReturnsTrue()
    {
        // Arrange
    ...
    [Fact]
    public void Given_ContentAndNotMatchingSignature_When_IsNotificationSignatureValid_Then_ReturnsFalse()
    {
        // Arrange
        const string notification =
            "{\"paymentId\":\"NOLV-8F9-08K-WGD\",\"externalId\":\"12345\",\"status\":\"CONFIRMED\",\"modifiedAt\":\"2018-12-12T13:24:52\"}";
        ...
        // Act
        var result =
            calculator.IsNotificationSignatureValid("ztiaCua1Y+uBkPA2hl48m6I5kqn6bHVa9KpNvtMyMcQ=", notification);
